          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-blue-100">
                Get visa updates, scholarship alerts, and expert tips directly in your
                inbox
              </p>
            </div>
            <div className="flex gap-3 w-full md:w-auto">
              <input
                ...
                className="px-6 py-3 rounded-xl flex-1 md:w-80 outline-none"
              />
              <button className="px-8 py-3 bg-white text-brand-blue rounded-xl font-semibold hover:bg-blue-50 transition-all whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="container mx-auto px-6 pt-16 pb-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              India's leading immigration and education consultancy. Established 2009.
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center hover:bg-brand-blue hover:text-white transition-all hover:scale-110"
                >
                  <Icon size={18} />
                </a>
              ))}
        ...
        <div className="text-center mt-8 pt-8 border-t border-slate-800">
          <p className="text-xs text-slate-600">
            Empowering dreams since 2009 | Served 10,000+ students across 25+ countries
          </p>
        </div>
      </div>
    </footer>
