...
const whyUs = [
  {
    ...
    desc: "We partner exclusively with universities recognized by NMC & WHO",
    bg: "bg-blue-900",
  },
  {
    icon: <FiDollarSign className="text-2xl" />,
    title: "Zero Hidden Fees",
    desc: "Transparent pricing — no surprise costs at any stage of admission",
    bg: "bg-blue-800",
  },
  {
    icon: <FiUsers className="text-2xl" />,
    title: "Dedicated Counsellors",
    desc: "1-on-1 expert guidance from NEET score to graduation",
    bg: "bg-blue-700",
  },
  {
    icon: <FiTrendingUp className="text-2xl" />,
    title: "98% Success Rate",
    desc: "Over 4000+ students placed in top medical universities worldwide",
    bg: "bg-amber-600",
  },
  {
    icon: <FiClock className="text-2xl" />,
    title: "Fast Processing",
    desc: "Admission confirmed in 15-30 days — fastest in the industry",
    bg: "bg-blue-900",
  },
  {
    icon: <FiStar className="text-2xl" />,
    title: "Post-Admission Support",
    desc: "FMGE/NEXT coaching guidance, airport pickup, hostel assistance",
    bg: "bg-blue-800",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "MBBS is typically a 5.5 to 6-year program including internship, depending on the country and university. In Russia and CIS countries it's 6 years; in India it's 5.5 years.",
  },
  {
    question: "Is NEET mandatory for MBBS abroad?",
    answer:
      "Yes, NEET qualification is mandatory for Indian students pursuing MBBS abroad to practice in India after completing the degree. Minimum qualifying marks: General 50th percentile, OBC/SC/ST 40th percentile.",
  },
  {
    question: "Can I practice in India after MBBS abroad?",
    answer:
      "Yes! After completing MBBS abroad from an NMC-approved university, you must clear the FMGE (Foreign Medical Graduate Exam) or the upcoming NEXT exam conducted by NMC to register and practice in India.",
  },
  {
    question: "What is the average cost of MBBS?",
    answer:
      "Costs vary: Government colleges in India: ₹10K–1L/year | Private India: ₹10–25L/year | MBBS Abroad (Russia, Uzbekistan): $2,800–4,000/year | Georgia, Kazakhstan: $3,200–5,000/year. Total abroad cost: ₹20–35 lakhs for the full course.",
  },
  {
    question: "What is the minimum NEET score for MBBS abroad?",
    answer:
      "There is no specific minimum score for admission — only the qualifying percentile (50th for General, 40th for OBC/SC/ST). However, universities may have their own criteria. We help match your score to the right university.",
  },
  {
    question: "Do MBBS abroad universities teach in English?",
    answer:
      "Yes! All our partner universities in Russia, Georgia, Uzbekistan, Kazakhstan, and Kyrgyzstan offer English-medium MBBS programs specifically designed for international students.",
  },
];
