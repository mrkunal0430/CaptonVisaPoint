...
import { FiUser, FiSend, FiCheck, FiX, FiGlobe, FiStar } from "react-icons/fi";
...
const HospitalityJobsForm = forwardRef(function HospitalityJobsForm(_, ref) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${API_URL}/service-leads/hospitality-jobs`, payload);
      if (res.data.success) {
        setStatus({ type: "success", message: res.data.message });
        trackFormSubmission("HOSPITALITY_JOBS", payload);
        setFormData({
          fullName: "", email: "", phone: "", city: "", whatsapp: "",
          qualification: "", specialization: "", yearsOfExperience: "",
          languageCertification: "", jobField: "Hospitality",
          countryPreferenceWork: [], passportAvailable: "", planToGo: "",
        });
        setStep(1);
      }
    } catch (error) {
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 mb-3">
            Start Your Hospitality Career Abroad
          </h2>
          <p className="text-slate-500 max-w-xl mx-auto">
            Share your profile and our hospitality recruitment specialist will match you with top opportunities within 24 hours.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-6 sm:p-8">
            ...
            {/* Status */}
            {status.message && (
              <div className={`mb-5 p-4 rounded-xl flex items-start gap-3 ${status.type === "success" ? "bg-green-50 text-green-800 border border-green-200" : "bg-red-50 text-red-700 border border-red-200"}`}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              {step === 2 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
                  <div className="flex items-center gap-2 text-blue-700 font-semibold mb-4">
                    <FiStar size={16} /><span>Your Profile</span>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select name="qualification" value={formData.qualification} onChange={handleChange} className={inputClass}>
                        ...
                        <option value="Degree in Hospitality">Degree in Hospitality / Tourism</option>
                    ...
                    <div>
                      ...
                      <select name="specialization" value={formData.specialization} onChange={handleChange} className={inputClass}>
                        ...
                        <option value="Housekeeping">Housekeeping / Room Attendant</option>
                        <option value="Food & Beverage Service">Food & Beverage Service</option>
                        <option value="Chef / Cook">Chef / Cook / Kitchen Staff</option>
                        <option value="Bartender / Barista">Bartender / Barista</option>
                        <option value="Spa & Wellness">Spa & Wellness</option>
                        <option value="Hotel Management">Hotel Management</option>
                        <option value="Event Management">Event Management</option>
                        <option value="Guest Relations">Guest Relations / Concierge</option>
                        <option value="Other">Other</option>
                      </select>
                    </div>
                  </div>
                  <div>
                    ...
                    <select name="yearsOfExperience" value={formData.yearsOfExperience} onChange={handleChange} className={inputClass}>
                      <option value="">Select</option>
              ...
              {step === 3 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                      <label className={labelClass}>Language / Cert</label>
                      <select name="languageCertification" value={formData.languageCertification} onChange={handleChange} className={inputClass}>
                        <option value="">Select</option>
                    ...
                    <div>
                      ...
                      <select name="planToGo" value={formData.planToGo} onChange={handleChange} className={inputClass}>
                        ...
                        <option value="Within 6 months">6 months</option>
...
export default HospitalityJobsForm;
