...
export default function LocationConsultantPage({
  seoTitle,
  seoDescription,
  seoKeywords,
  canonical,
  ...
  const faqData = [
    {
      q: `Why choose a consultant for ${title}?`,
      a: `A good consultant helps students understand MBBS in India and MBBS abroad options, country comparison, budget planning, documentation and admission steps in a structured way.`,
    },
    {
      q: `Can students from ${title} get MBBS abroad guidance?`,
      a: `Yes, students from ${title} can get support for country selection, documentation guidance, counselling and admission planning.`,
    },
    {
      q: `Which countries are commonly considered by students from ${title}?`,
      a: `Russia, Kazakhstan, Georgia, Uzbekistan, Kyrgyzstan and Tajikistan are commonly explored options.`,
    },
    {
      q: `Does Capton Visa Point support nearby students also?`,
      a: `Yes, Capton Visa Point can support students from nearby areas as well with MBBS admission guidance.`,
    },
  ];
        ...
        <section className="py-14 md:py-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl md:text-4xl font-bold text-slate-900">
              MBBS admission guidance for students in {title.replace("MBBS Consultant in ", "").replace("MBBS Consultant near ", "")}
            </h2>

            <p className="mt-5 text-slate-600 leading-8 text-base md:text-lg">
              Students searching for a trusted consultant usually want clarity on MBBS in India,
              MBBS abroad, country comparison, fees, documents and counselling process.
            </p>

            <p className="mt-4 text-slate-600 leading-8 text-base md:text-lg">
              Capton Visa Point helps students understand the process in a structured way and
              supports better decision-making with clear guidance.
            </p>
          </div>
        </section>
